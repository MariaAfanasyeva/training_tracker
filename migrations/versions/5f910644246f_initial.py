...
def downgrade():
    ...
    sa.Column('id', sa.INTEGER(), server_default=sa.text("nextval('weight_id_seq'::regclass)"), autoincrement=True, nullable=False),
    ...
    sa.Column('id', sa.INTEGER(), autoincrement=True, nullable=False),
    sa.Column('distance', sa.NUMERIC(precision=10, scale=2), autoincrement=False, nullable=True),
    sa.Column('units', sa.VARCHAR(length=100), autoincrement=False, nullable=True),
